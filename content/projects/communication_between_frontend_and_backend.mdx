---
title: React & Node (Express) Communication
description: In this project, you will learn how to establish communication between a React-based frontend and a Node.js backend using Express.
date: "2025-04-02"
url: https://github.com/IgorCastilhos/react_express_communication
published: true
repository: IgorCastilhos/react_express_communication
---
